use super::board::{CastlingRights, ChessPiece, PieceColor};
use serde::{Deserialize, Serialize};

const ZHASH_TABLE: [u64; 781] = [
...
mod tests {
    ...
    #[test]
    fn test_kind_of_piece() {
        let piece_combinations = [
            (ChessPiece::Pawn, PieceColor::Black, 0),
            (ChessPiece::Pawn, PieceColor::White, 1),
            (ChessPiece::Knight, PieceColor::Black, 2),
            (ChessPiece::Knight, PieceColor::White, 3),
            (ChessPiece::Bishop, PieceColor::Black, 4),
            (ChessPiece::Bishop, PieceColor::White, 5),
            (ChessPiece::Rook, PieceColor::Black, 6),
            (ChessPiece::Rook, PieceColor::White, 7),
            (ChessPiece::Queen, PieceColor::Black, 8),
            (ChessPiece::Queen, PieceColor::White, 9),
            (ChessPiece::King, PieceColor::Black, 10),
            (ChessPiece::King, PieceColor::White, 11),
        ];

        for (piece, color, expected) in piece_combinations {
            assert_eq!(ZHash::kind_of_piece(piece, color), expected);
        }
    }

    fn check_zobrist_hash(fen: &str, expected_key: u64) {
        let board_state = ChessBoardState::from_fen(fen).unwrap();
        assert_eq!(board_state.zhash.0, expected_key);
    }
    ...
    #[test]
    fn test_zobrist_hash_after_e2e4() {
        check_zobrist_hash(
    ...
    #[test]
    fn test_zobrist_hash_after_e2e4_d7d5() {
        check_zobrist_hash(
    ...
    #[test]
    fn test_zobrist_hash_after_e2e4_d7d5_e4e5() {
        check_zobrist_hash(
    ...
    #[test]
    fn test_zobrist_hash_after_e2e4_d7d5_e4e5_f7f5() {
        check_zobrist_hash(
    ...
    #[test]
    fn test_zobrist_hash_after_e2e4_d7d5_e4e5_f7f5_e1e2() {
        check_zobrist_hash(
    ...
    #[test]
    fn test_zobrist_hash_after_e2e4_d7d5_e4e5_f7f5_e1e2_e8f7() {
        check_zobrist_hash(
    ...
    #[test]
    fn test_zobrist_hash_after_a2a4_b7b5_h2h4_b5b4_c2c4() {
        check_zobrist_hash(
    ...
    #[test]
    fn test_zobrist_hash_after_a2a4_b7b5_h2h4_b5b4_c2c4_b4c3_a1a3() {
        check_zobrist_hash(
